@extends('dashboard.layouts.master', ['title' => trans('dashboard.add_FAQ')])
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4>{{ trans('dashboard.add_new_FAQ') }}</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">{{trans('dashboard.add_FAQ')}}</li>
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.FAQ-store')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="answer_en" id="answer_en" class="form-control @error('answer_en') is-invalid @enderror">{{ old('answer_en') }}</textarea>
                                @error('answer_en')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="answer_ar" id="answer_ar" class="form-control @error('answer_ar') is-invalid @enderror">{{ old('answer_ar') }}</textarea>
                                @error('answer_ar')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
