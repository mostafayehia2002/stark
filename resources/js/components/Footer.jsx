...
export default function Footer({ language }) {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/company/stark-brokers',
      icon: (
    ...
    {
      name: 'Instagram',
      url: 'https://instagram.com/starkbrokers',
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-6">
            {socialLinks.map((social, index) => (
              <a
                ...
                className="text-gray-600 hover:text-[#BE092B] transition-colors"
